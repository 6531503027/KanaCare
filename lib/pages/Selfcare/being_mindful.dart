            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    "Practice acceptance and letting go of worries about the past or future.\n\n"
                    "Regularly check in with yourself to maintain mindfulness throughout the day.",
                    style: TextStyle(
                      fontSize: 16,
                      color: Colors.white,
                    ),
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.pushNamed(context, '/SurveyPage3');
                        },
                        child: Text(
                          'Start',
                          style: TextStyle(
